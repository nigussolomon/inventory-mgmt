  ...
  const upperNavData = [
    {
      ...
      icon: IconPackage,
      links: [
        { label: "Product Categories", link: "/products/category" },
        { label: "Product Suppliers", link: "/products/suppliers" },
        { label: "Product Offerings", link: "/products/offerings" },
      ],
    },
    {
      label: "Warehouse",
      ...
      links: [
        { label: "Internal Warehouses", link: "/warehouses/internal" },
        { label: "Outsourced Warehouses", link: "/warehouses/outsourced" },
        { label: "Warehouse Partners", link: "/warehouses/partner" },
      ],
    },
    {
      label: "Inventory",
      ...
      links: [
        ...
        { label: "Refill Request", link: "/inventory/refill-request" },
      ],
    },
    {
      ...
      icon: IconUsersGroup,
      links: [
        { label: "Product Maintainers", link: "/personal/product-maintainers" },
        { label: "Warehouse Managers", link: "/personal/warehouse-managers" },
